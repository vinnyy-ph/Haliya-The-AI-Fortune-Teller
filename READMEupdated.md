...
2. **Change the directory to the repository and setup the environment**:
    ...
    ```
    ![image](images/331859116-7e230d5c-167f-48be-8667-55e93c74c05a.png)    
...
3. **Host the frontend server**:
   ...
   npm run dev
   ```
   ![image](images/331859647-3c1b2d40-c359-426f-9ed9-0088a0eb697f.png)  
   ...
   - **Host RASA server**
      ...
      ![image](images/331941621-dab99563-6a07-4c45-af69-c0b30fc95f93.png)
